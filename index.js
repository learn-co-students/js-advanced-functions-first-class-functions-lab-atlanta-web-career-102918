...
// returnFirstTwoDrivers() — Declare a variable with const that is
// assigned an anonymous function.
...
// If createFareMultiplier() receives an argument of 4, it will return a function that takes
...
// fetchSpecifiedDrivers() — This function takes two arguments, an array of drivers and
// either the returnFirstTwoDrivers() or returnLastTwoDrivers() function.
// Based on these two arguments, fetchSpecifiedDrivers() will return either the first two drivers
// or the last two drivers.

function fetchSpecifiedDrivers(drivers, eitherfunction) {
